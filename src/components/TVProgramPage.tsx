...
export default function TVProgramPage() {
  ...
  const [lastHoveredProgram, setLastHoveredProgram] = useState<Program>(programs[0]);
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto">
        <Swiper slidesPerView={4} spaceBetween={20} navigation={true} modules={[Navigation]} className="mt-5">
            ...
            <SwiperSlide key={program.id}>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-white/90 via-white/50 to-transparent p-3 flex items-end rounded-b-xl">
                  <p className="text-sm text-gray-700 font-medium truncate">{program.description}</p>
                </div>
              </div>
            </SwiperSlide>
          ))}
