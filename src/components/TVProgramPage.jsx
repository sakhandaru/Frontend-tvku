...
const programs = [
  {
    id: 1,
    title: 'Sapa Dosen',
    description: 'Dengan gravitasi yang lebih menarik, sapa dosen menyapa mahasiswa Universitas Dian Nuswantoro dengan memberikan materi pembelajaran yang berbeda di setiap episodenya, hanya dengan menyaksikannya melalui tayangan TVKU dan Youtube.',
    image: '/images/programTV/sapaDosen.png',
  },
  {
    id: 2,
    title: 'Campus On TV',
    description: 'Campus on TV merupakan media pembelajaran jarak jauh yang diberikan oleh Udinus untuk mempermudah mahasiswa dalam mengikuti perkuliahan. Campus On TV hadir bersama dosen Universitas Dian Nuswantoro untuk menyampaikan materi materi perkuliahan di setiap episodenya.',
    image: '/images/programTV/campusOnTv.png',
  },
  {
    id: 3,
    title: 'Campus Corner',
    description: 'Campus Corner sebagai etalase kampus untuk unjuk gigi menunjukkan prestasi-prestasinya dalam bentuk talkshow setiap Hari Kamis.',
    image: '/images/programTV/campusCorner.png',
  },
  {
    id: 4,
    title: 'Kabar Sepekan',
    description: 'Kabar Sepekan menyajikan berita dan informasi terkini yang dirangkum dalam sepekan kepada pemirsa.',
...
export default function TVProgramPage() {
  ...
  const [lastHoveredProgram, setLastHoveredProgram] = useState(programs[0]); // Default to the first program
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${activeProgram ? activeProgram.image : lastHoveredProgram.image})` }}
    >
      {/* Morph Shadow Gradient */}
      <div className="absolute top-0 left-0 w-2/5 h-full bg-gradient-to-r from-black via-black/50 to-transparent"></div>

      {/* Teks di Background (hanya muncul saat hover) */}
      {activeProgram && (
        <motion.div
            ...
            <SwiperSlide key={program.id}>
              <div
                ...
                onMouseEnter={() => {
                  ...
                  setLastHoveredProgram(program); // Update the last hovered program
                }}
